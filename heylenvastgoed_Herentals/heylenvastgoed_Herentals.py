    ...
    while True:
        ...
        #     print li
            ...
            if soup2.find('i',class_='icon area-big'):
                sq_mt = re.findall('\d+',soup2.find('i',class_='icon area-big').find_previous('li').text)[0]
            ...
            #     rec['property_type'] = "property_for_sale"
...
def write_json():
    ...
    with open('heylenvastgoed_Herentals.json','w') as f:
        f.write(data)
write_json()
